...
Version 0.3
* Library updated to 2.13.0 version of pivottable (see [2.12.0](https://github.com/nicolaskruchten/pivottable/releases/tag/v2.12.0) for new functionality)
* Add subtotal renderer [pivottable-subtotal-renderer](https://github.com/nagarajanchinnasamy/pivottable-subtotal-renderer)
